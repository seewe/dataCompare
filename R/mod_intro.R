...
mod_intro_ui <- function(id) {
	...
	tabItem(
		...
		fluidRow(
			column(width = 6,
			       img(src = "www/dfComparatorhex.png", width="100%")
			       ),
			column(width = 6,
			       box(
			         ...
			         p("This tab allows the user to load data and perform comparison of loaded data.", br(),
			           ...
			           strong(".csv, .tsv and .rds"),".", "The maximal size of files accepted here is", strong("50Mb."), br(),
			       ...
			       box(
			         ...
			         tags$a("'explore' package vignette", target = "_blank", href = "https://cran.r-project.org/web/packages/explore/vignettes/explore.html"), br(),
